    ...
    <div class="col-lg-6 col-sm-6 d-flex flex-column ">
        ...
        <div>
            ...
            <div class="faction text-right mb-2 mt-auto">
                <button type="button" data-id="{{$the_product->id}}" id="add2cart" class="btn btn-success addtc"><i class="fa fa-cart-plus"></i> tambah ke keranjang</button>
            </div>
        </div>
    </div>
</div>
